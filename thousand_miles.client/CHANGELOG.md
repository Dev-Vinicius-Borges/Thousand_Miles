...
- Create Angular project with ng: `ng new thousand_miles.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`thousand_miles.client.esproj`).
